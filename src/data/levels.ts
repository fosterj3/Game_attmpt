...
export const LEVELS: LevelDef[] = [
  ...
  { id: 7, name: 'Grand Cascade', targetScore: 3000, moveLimit: 15, timeLimitSeconds: 90 },
  { id: 8, name: 'Match Master', targetScore: 3600, moveLimit: 15, timeLimitSeconds: 80 },
  { id: 9, name: 'Rising Stakes', targetScore: 4200, moveLimit: 14, timeLimitSeconds: 75 },
  { id: 10, name: 'Legend\'s Trial', targetScore: 5000, moveLimit: 14, timeLimitSeconds: 70 },
];
